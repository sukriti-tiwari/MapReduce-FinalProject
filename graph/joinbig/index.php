        ...
        function getLineGraph() {
            FusionCharts.ready(function () {
                var revenueChart = new FusionCharts({
                    ...
                    "dataSource": {
                        "chart": {
                            "caption": "Amount of data allocated from datasources to datacenters",
                            "subCaption": "Statistic metric of decision λ and x",
                  ...
                  var revenueChart = new FusionCharts({
                      ...
                      "dataSource": {
                         ...
                         "caption": "Amount of data allocated from datasources to datacenters",
                            "subCaption": "Statistic metric of decision λ and x",
                              "yAxisName": "Total Cost",
                              "paletteColors": "#0075c2,#1aaf5d,#f2c500,#f45b00,#8e0000,#993333,#663300,#990099,#336600,#595959,#00ffff",
                              "bgColor": "#ffffff",
                              "showBorder": "0",
                              "use3DLighting": "0",
                              "showShadow": "0",
    ...
    <section>
      ...
      <nav>
        ...
        <article class="homeDetail">
            <h1 class="homePage">Cost-Aware Big Data Processing across
Geo-distributed Datacenters</h1>
        </article>
